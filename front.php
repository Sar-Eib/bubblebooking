...
<div class="container-fluid">
    ...
    <div class="row mt-1">
        <div class="col p-3 m-2 d-flex justify-content-center flex-row flex-wrap" id="washingTimes">
            <?php
            $washtimes = $db->sql("SELECT * FROM washtime INNER JOIN washstatus ON washTimeStatusId = washStatusId");
            foreach($washtimes as $washTime) {
                ?>
                <div type="button" id="bookBtn1" data-bs-toggle="modal" data-bs-target="#logIn" class="rounded-3 m-3 col-5 <?php echo ($washTime->washTimeStatusId == 1) ? "bg-primary" : "bg-secondary"; ?>">
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <div class="mb-3">
                                ...
                                <input type="text" id="userName" class="form-control" placeholder="f.eks. 2st4">
                            </div>
                            <div class="mb-3">
                        ...
                        <div class="modal-footer">
                            <button type="button" id="bookBtn" class="btn btn-secondary btn-lg px-5 rounded-5" data-bs-toggle="modal" data-bs-target="#bookTime">Log ind</button>
                        </div>
                    </div>
                </div>
            </div>
            <div class="modal" id="bookTime" tabindex="-1">
                <div class="modal-dialog modal-dialog-centered">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <div class="mb-3 mt-1">
                                <h4 id="washTime">Tid: 07:00 - 09:00</h4>
                            </div>
                            <div class="mb-3 mt-2">
                        ...
                        <div class="modal-footer">
                            ...
                            <button type="button" class="btn btn-secondary" id="createBookingBtn" data-bs-dismiss="modal">Opret</button>
                        </div>
                    </div>
                </div>
            </div>
